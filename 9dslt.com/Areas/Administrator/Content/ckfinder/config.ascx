...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = "~/Areas/Administrator/Content/";
        //BaseUrl = "http://43.239.220.2:8383/Areas/Administrator/Content/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("~/Areas/Administrator/Content/");
        //BaseDir = HttpContext.Current.Server.MapPath("~/Areas/Administrator/Content/");
